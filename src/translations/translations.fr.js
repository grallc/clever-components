...
export const translations = {
  ...
  'cc-addon-backups.delete.manual.description.es-addon': () => sanitize`Vous pouvez supprimer cette sauvegarde manuellement grâce à l'outil <a href="https://curl.se/docs/">cURL</a> en exécutant cette commande :`,
